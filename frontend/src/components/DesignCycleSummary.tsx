    ...
    <div className="space-y-1.5">
      <div className="flex items-center justify-between text-[10px] text-gray-500 mb-2 pb-2 border-b border-[#1a1a1a]">
        ...
        <span className="text-white font-medium">
          Best: {bestRound.delta_g_binding_kcal_mol != null
            ? bestRound.delta_g_binding_kcal_mol.toFixed(2) + ' kcal/mol'
            : (bestRound.binding_score * 100).toFixed(1) + '%'}
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2 mt-0.5">
                    {r.delta_g_binding_kcal_mol != null
                      ? <span className="text-[10px] font-bold text-white">{r.delta_g_binding_kcal_mol.toFixed(2)} kcal/mol</span>
              ...
              <div className="px-3 pb-3 pt-1 border-t border-[#1a1a1a] animate-fade-in space-y-2">
                <div className="grid grid-cols-3 gap-2 text-[9px]">
                  <div className="bg-[#0a0a0a] rounded p-2">
                    <div className="text-gray-500">ΔG Binding</div>
                    <div className="text-white font-bold">
                      {r.delta_g_binding_kcal_mol != null
                        ? r.delta_g_binding_kcal_mol.toFixed(2) + ' kcal/mol'
                        : (r.binding_score * 100).toFixed(1) + '%'}
                    </div>
                  </div>
                  <div className="bg-[#0a0a0a] rounded p-2">
